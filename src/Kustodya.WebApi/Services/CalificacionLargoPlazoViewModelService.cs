...
{
    public class CalificacionLargoPlazoViewModelService : ICalificacionLargoPlazoViewModelService
    {
        private readonly IEnumExtensions _enumExtensions;

        public CalificacionLargoPlazoViewModelService(IEnumExtensions enumExtensions)
        {
        ...
        {
            List<EnumValueModel> result = _enumExtensions.GetValues<PlazoLargo>();
