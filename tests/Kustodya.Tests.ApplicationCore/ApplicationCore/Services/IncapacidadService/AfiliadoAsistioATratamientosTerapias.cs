...
{
    public class AfiliadoAsistioATratamientosTerapias
    {
        ...
        public AfiliadoAsistioATratamientosTerapias()
        {
        ...
        [Theory]
        [MemberData(nameof(AfiliadoAsistioATratamientosTerapiasTestData.TestData),
            MemberType = typeof(AfiliadoAsistioATratamientosTerapiasTestData))]
        public async Task Deberia_Retornar_TrueSoloSiElAfiliadoAsisteATratamientos(bool asisteATratamientos, bool valido)
        {
            ...
            _mockAfiliadoRepo.Setup(i => i.GetByIdAsync(afiliadoId))
                .Returns(Task.Run(() =>
                {
                    ...
                    {
                        Id = afiliadoId,
                        AsisteATratamientos = asisteATratamientos
                    };
                }));

            _incapacidadService = new IncapacidadService(_mockIncapacidadRepo.Object, _mockAfiliadoRepo.Object, null);

            var result = await _incapacidadService.AfiliadoAsistioATratamientosTerapias(incapacidadId);
        ...
        public async Task Deberia_RetornarException_SiLaIncapacidadNoExiste()
        {
            ...
            await Assert.ThrowsAsync<IncapacidadNotFoundException>(async () => await _incapacidadService.AfiliadoAsistioATratamientosTerapias(incapacidadNoExistenteId));
        }
        ...
        public async Task Deberia_RetornarException_SiElAfiliadoNoExiste()
        {
            ...
            await Assert.ThrowsAsync<AfiliadoNotFoundException>(async () => await _incapacidadService.AfiliadoAsistioATratamientosTerapias(incapacidadId));
        }
        ...
        public async Task Deberia_RetornarExcepcion_SiAfiliadoNoInformacion()
        {
            ...
            _mockAfiliadoRepo.Setup(a => a.GetByIdAsync(afiliadoId))
                .Returns(Task.Run(() => { return new Afiliado() { Id = afiliadoId, AsisteATratamientos = null }; }));

            _incapacidadService = new IncapacidadService(_mockIncapacidadRepo.Object, _mockAfiliadoRepo.Object, null);

            var result = _incapacidadService.AfiliadoAsistioATratamientosTerapias(incapacidadId);
